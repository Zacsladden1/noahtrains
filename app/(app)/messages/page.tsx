...
export default function MessagesPage() {
  ...
  return (
    <div className="mobile-padding space-y-6 max-w-4xl mx-auto bg-black min-h-screen">
      {/* Header */}
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl md:text-3xl font-heading text-white">Messages</h1>
          <p className="text-white/60">Chat with your coach</p>
        </div>
      </div>
        ...
        <CardHeader className="border-b border-white/20">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <CardTitle className="text-lg text-white">Noah (Coach)</CardTitle>
          ...
          <div className="h-96 overflow-y-auto p-4 space-y-4">
            {messages.length === 0 ? (
              <div className="text-center py-12">
                <MessageCircle className="w-12 h-12 text-gold mx-auto mb-4 opacity-50" />
                <p className="text-white/60">No messages yet</p>
                <p className="text-sm text-white/60">Start a conversation with your coach</p>
              </div>
            ) : (
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="flex-1">
              <Input
                ...
                className="border-0 bg-white/10 text-white placeholder:text-white/50 focus-visible:ring-0 focus-visible:ring-offset-0"
              />
            </div>
            <Button 
              onClick={sendMessage}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        <Card className="mobile-card">
          <CardContent className="p-4">
            <h3 className="font-semibold mb-2 text-white">Share Progress Photos</h3>
        ...
        <Card className="mobile-card">
          <CardContent className="p-4">
            <h3 className="font-semibold mb-2 text-white">Schedule Check-in</h3>
            <p className="text-sm text-white/60 mb-3">
